...
@bp.route("/")
def index():
    ffmpeg_path = len(Config.query.get(1).ffmpeg_directory) > 0
    ...
    genius = "genius" in Config.get_metadata_sources().split(";")
...
def utility_processor():
    ...
    return {"path_exists": path_exists, "get_ext": get_ext, "check_metadata": check_metadata}
